        ...
        {images.length > 0 && (
          <>
            ...
            <div className="close-btn-container">
              <CustomCancelIconButton aria-label="close" className="close-btn" onClick={onClose}>
                <CancelRoundedIcon />
        ...
        <Typography sx={{ fontSize: "10px" }}>
          <Box component="span" display="flex" alignItems="center">
            ...
            <Avatar
              ...
              sx={{ width: 13, height: 13, marginLeft: 1, fontSize: 12, textTransform: "none"}}
            />
            <Avatar
              // alt="organization"
              src="/path/to/profile2.jpg"
              sx={{ width: 13, height: 13, marginLeft: 1, marginRight: 1, fontSize: 12, textTransform: "none" }}
            />
            +
          </Box>
        </Typography>
